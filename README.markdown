...
- `git clone git://github.com/chrishamant/dotfiles ~/.dotfiles`
- `cd ~/.dotfiles`
- `rake install`
...
[open an issue](https://github.com/chrishamant/dotfiles/issues) on this repository
